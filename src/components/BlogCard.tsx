...
const BlogCard = ({ blog }: BlogProps) => {
  ...
  return (
    <div className="bg-[#1E3E62] rounded-md overflow-hidden">
      <Image
        src={image}
        alt={title}
        width={300}
      ...
      />
      <div className="p-6">
        <p className="rounded-md px-6 py-3 bg-[#0B192C] text-white w-fit">
          News
        </p>
        ...
        <div className="mt-4 mb-4 w-full h-[1.5px] bg-gray-400 opacity-45">
          <div className="flex items-center justify-between">
            ...
            <button className="text-base hover:text-[#67a4ea] text-gray-200 underline font-bold">
              Read More
            </button>
          </div>
        </div>
