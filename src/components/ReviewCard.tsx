...
const ReviewCard = ({ review }: ReviewProps) => {
  ...
  return (
    <div className="rounded-md overflow-hidden bg-[#1E3E62] m-4">
      <div className="p-6">
      ...
      <div className="px-6 py-3 mb-3 w-fit mx-auto rounded-full flex items-center space-x-3 bg-[#FF6500] text-white font-bold">
        <span>{rating}/5</span>
